...
def create_feedback_event():
    try:
        ...
        # Asignar UUID si no llega
        feedback_id = data.get("feedback_id") or str(uuid.uuid4())
        feedback_id = ensure_uuid(feedback_id)
        ...
        vals = [
            feedback_id, data["session_id"],
            data["item_type"], data.get("item_id"), provider, data.get("provider_playlist_id"),
            ...
            data.get("client_device"), data.get("client_version"), data.get("trace_id"),
